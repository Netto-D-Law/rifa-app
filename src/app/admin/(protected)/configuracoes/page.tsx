...
import { atualizarConfigAction, atualizarImagemAction, expandirNumerosAction, resetarRifaAction } from '../actions';
import ImageUploader from '@/components/admin/ImageUploader';
import SalvarConfigForm from './SalvarConfigForm';
import ExpandirNumerosForm from './ExpandirNumerosForm';
import ResetarRifaForm from './ResetarRifaForm';
import BackupGeralButton from '@/components/admin/BackupGeralButton';
...
export default async function ConfiguracoesPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <ResetarRifaForm action={resetarRifaAction.bind(null, raffle.id)} />
    </div>
  );
}
