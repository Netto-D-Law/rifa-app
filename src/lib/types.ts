...
export interface Order {
  ...
  valor_total: number;
  status: StatusPedido;
  // Registro permanente dos números atribuídos na criação do pedido — ao
  // contrário do vínculo em raffle_numbers.pedido_id (que é apagado quando
  // o pedido é liberado/cancelado), este campo nunca muda depois de
  // criado. É a fonte confiável para auditoria: mostra quais números
  // foram sorteados/escolhidos mesmo que o pedido tenha sido cancelado.
