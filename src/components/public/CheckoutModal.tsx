...
export default function CheckoutModal({
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setCarregando(true);
    // Quando o pagamento é no cartão (presencial), o nome/contato do
    // titular são anexados ao campo "nome" enviado ao banco, já que ainda
    // não temos colunas próprias para isso. O clube já tem coluna própria
    // (orders.clube) e é enviado separadamente.
