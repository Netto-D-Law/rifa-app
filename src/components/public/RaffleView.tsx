  ...
  return (
    <main className="min-h-screen pb-24">
      ...
      {/* Hero / ticket do prêmio — o fundo-site.jpg preenche toda a faixa (pode
          ...
          do clube) fica intacta e centralizada na coluna esquerda. */}
      <div
      ...
      >
        <div className="mx-auto grid max-w-6xl items-center gap-6 md:grid-cols-[220px_1fr_220px]">
          {/* Coluna esquerda: marca d'água completa, sem distorcer */}
          <div className="flex justify-center">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/marca-agua-completa.jpg"
              alt="Rotary Club de São Paulo Butantã"
              className="h-auto w-full max-w-[220px] rounded-xl object-contain shadow-xl"
            />
          </div>
